			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<!-- end: PAGE TITLE -->
					<center> <h2> Customer Invoice </h2></center> <hr/>
...
<?php 
                ...
                include"db.php";
					...
					$id = $_GET["Print_id"];
							...
							$product_query = "SELECT appointment.id,appointment.name,appointment.invid,appointment.pay_status,appointment.service,appointment.date,appointment.time,appointment.mobile,appointment.email,services.service_name,services.price from appointment INNER JOIN services on appointment.service=services.service_name ORDER BY appointment.id DESC limit 1";
					...
					<div class="invoice">
						<div class="row invoice-top">
							...
							<div class="col-md-6 col-sm-6 col-xs-6 tagline">
								...
								<p class="company-address">Suite # 618, 87 Color Spray Ltd, Sector # 7, Uttara, Dhaka-1230</p>
						...
						<div class="row invoice-middle">
							...
							<div class="col-md-6 col-sm-6 col-xs-6 invoice-info">
								<table border="0">
								<tr><td>Invoice Id </td><td>:</td><td><?php
echo $invid;
?> </td></tr>
...
?>
									...
									<tr><td>Payment</td><td>:</td><td> <?php if($pay_status == 0){
										echo "Not Completed";
									}
									else {
										echo "Completed";
						...
						<div class="row invoice-table">
							<div class="col-md-12">
								<table border="0" class="itemLists">
									<thead>
										<tr><th>Sl No</th><th>Date</th><th>Time</th><th>Service name</th><th>Price</th></tr>
									</thead>
									<tbody>
